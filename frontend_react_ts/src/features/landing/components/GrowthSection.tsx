  ...
  return (
    <section className="relative z-10 py-24 px-6 max-w-5xl mx-auto border-t border-zinc-800/60">
      <div className="text-center max-w-2xl mx-auto mb-16">
        <Badge
          variant="default"
          className="mb-4 text-emerald-400 border-emerald-500/30 bg-emerald-500/10"
        >
        ...
        <p className="mt-4 text-sm text-zinc-400 leading-relaxed">
          Chatbots treat thoughts as disposable conversations to be summarized
          into bullet points. Forge tracks how your Sparks connect across time,
          surfacing creative tension and emergent patterns.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto p-8 rounded-2xl bg-zinc-900/60 border border-zinc-800 shadow-2xl relative">
        ...
        <div className="space-y-4 text-sm text-zinc-300 leading-relaxed font-serif">
          <p>
            You repeatedly connect unfinished projects with difficulty deciding
            where your attention should go.
          </p>
          <p>
            At the same time, you describe keeping several options open as
        ...
        <div className="mt-8 pt-4 border-t border-zinc-800/80 flex items-center justify-between text-xs text-zinc-500">
          <span className="flex items-center gap-1">
            <Lightbulb className="w-3.5 h-3.5 text-amber-400" /> Grounded in 3
            Sparks
          </span>
