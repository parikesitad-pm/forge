      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6 space-y-6">
          ...
          <p className="text-base text-zinc-300 leading-relaxed">
            Owl is designed specifically for people who are tired of chatbots
            that pretend to have all the answers.
          </p>
          <p className="text-sm text-zinc-400 leading-relaxed">
            Instead of manufacturing certainty or prescribing life advice, Owl
            watches your thought evolution, questions unexamined assumptions,
            and asks what you may not have noticed yet.
          </p>
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="p-5 rounded-xl bg-zinc-950/60 border border-rose-900/30">
            ...
            <p className="text-xs text-zinc-400 italic">
              &ldquo;The reason you struggle with this is procrastination. Here
              are 5 productivity steps you must follow to resolve your
              dilemma...&rdquo;
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-pink-950/20 border border-pink-500/40 shadow-lg shadow-pink-950/20">
            ...
            <p className="text-sm text-zinc-200 leading-relaxed font-serif">
              &ldquo;You seem to return to the tension between preserving your
              freedom and taking responsibility for a single outcome. What
              changes if choosing doesn&rsquo;t mean losing the other
              possibilities?&rdquo;
            </p>
